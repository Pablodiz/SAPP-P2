var Navbar = (props) => {
    ...
    const handleLogout = (e) => {
        ...
        if (idToken) { // User was logged in with OAuth/OIDC.
            // Request the OpenID Provider to log out the end user.
            // See https://openid.net/specs/openid-connect-rpinitiated-1_0.html.
            const postLogoutRedirectUri = 'http://127.0.0.1:8888/tasks-service/dashboard/';
            sessionStorage.removeItem('idToken');
            window.location.replace('http://127.0.0.1:7777/connect/logout?' +
