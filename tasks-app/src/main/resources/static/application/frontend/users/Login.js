var Login = (props) => {
    ...
    const handleSSO = async () => {
        ...
        window.location.replace('http://127.0.0.1:7777/oauth2/authorize?response_type=code&client_id=tasks_app&redirect_uri=' +
            encodeURIComponent(redirectUri) + '&scope=openid&code_challenge=' + codeChallenge + '&code_challenge_method=S256');
